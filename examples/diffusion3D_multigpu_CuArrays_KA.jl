...
# Numerics
nx, ny, nz = 1024, 2048, 1024;                             # Number of gridpoints in dimensions x, y and z
...
T     = CUDA.zeros(Float32, nx, ny, nz);
Cp    = CUDA.zeros(Float32, nx, ny, nz);
dTedt = CUDA.zeros(Float32, nx, ny, nz);
